...
public class ConcursoDTO implements Serializable{
	...
	public ConcursoDTO(String titulo, int id_trabajadores, String fechaentrega, String fases, String etiquetas,
			String adjunto, String descripcion, String comentarios, int id, String estado) {
		super();
		this.titulo = titulo;
