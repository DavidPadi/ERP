...
public class TareaMontajeDTO implements Serializable{
	...
	public TareaMontajeDTO() {
		super();
	}
	public TareaMontajeDTO(String titulo, int id_trabajadores, String fechaentrega, String fases, String etiquetas,
