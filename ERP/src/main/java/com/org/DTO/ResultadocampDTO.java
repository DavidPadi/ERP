...
public class ResultadocampDTO implements Serializable{
	...
	public ResultadocampDTO() {
		super();
	}
	public ResultadocampDTO(String titulo, int id_trabajadores, String fechaentrega, String fases, String etiquetas,
