...
public class ImplantacionDTO implements Serializable{
	...
	public ImplantacionDTO() {
		super();
	}
	public ImplantacionDTO(String titulo, int id_trabajadores, String fechaentrega, String fases, String etiquetas,
