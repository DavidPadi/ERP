...
<input type="button" class="btn1" id="clonar" value="CLONAR FILA" />
 <button type="button" class="btn btn-success" style='width: 70px; height: 40px' data-toggle="modal" data-target="#NuevaCampaña"><i class="fa fa-plus" aria-hidden="true"></i></button>
		<table class="tableizer-table" id="tabla-pz">
			<tbody id="tabla_sel">
				...
				<c:forEach items="${campanha}" var="a" varStatus="estado">
					<tr>
					<form action="Editar_Campaña" method="POST" enctype="multipart/form-data">
	...
	<div class="modal fade" id="NuevaCampaña" tabindex="-1" ole="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="Campaña_Nueva" method="POST" enctype="multipart/form-data">
						<div class="form-row">
								...
								<div class="form-group col-md-8">
									<div class="form-group">
										<label for="estado">Estado</label> <br /> 
											<select name="estado">
												<option value="concursosolodiseño">Concurso (Solo diseño)</option>
												<option value="concursodiseñoimpl">Concurso (Diseño implantacion)</option>
